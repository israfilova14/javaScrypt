...
//     })
//   const getProducts = () => {
//   const promise = fetch(""nortwind.vercel.app/api/products"");
...
//  const promi =fetch("https://nortwind.vercel.app/api/products")
//  promise.then((val)=>val.json()).then((data)=>{
//     console.log(data);
//     data.forEach(elem=>{
//         console.log(elem.id);
//     })
// })
//  promi.then(res=>res.json())
//  .then(data=>{
//     console.log(data);
//     data.forEach(elem=>{
//         console.log(elem);
...
//    const promi =fetch("https://northwind.vercel.app/api/products") 
//    promi.then((val)=>val.json()).then((data)=>{
//     console.log(data);
//     data.forEach(elem=>{
//         console.log(elem); 
//     })
...
const fetchProducts = async ()=>{
   ...
   const table = document.querySelector(".tbody");
    fetchProducts().then((data)=>{
        ...
        newTd.innerText=item.id;
        newNameTd.innerText=item.name;
        newPrice.innerText = item.unitPrice;
        ...
        delet.addEventListener("click", async (e) => {
            console.log(delet.getAttribute("data", item.id));
            console.log(edit);
            e.target.parentElement.remove();
          });

        newTr.append(newTd,newNameTd,newPrice,country,delet,edit,detail);
